...
As I am not working a lot of time on this the plans I have for the moment are to add some more date "leap" methods (weeks and months are currently possible auto-calculated, also jump to an arbitrary date). 
...
+ currently month and week views are available and switching between them (you have to load events again)
